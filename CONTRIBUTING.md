# Contributing to AumAI Linguaforge
...
### Setup
```bash
git clone https://github.com/aumai/aumai-linguaforge.git
...
### Good First Issues
New to the project? Start with issues labeled [`good first issue`](https://github.com/aumai/aumai-linguaforge/labels/good%20first%20issue).
...
- [GitHub Discussions](https://github.com/aumai/aumai-linguaforge/discussions)
